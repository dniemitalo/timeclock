...
<div class="main">
<p>Hours in the last 6 weeks:<p>
<?php
require_once 'db.php';
$teams = array("967","4150","4324","10107");
foreach ($teams as $team){
	$sql = "SELECT team, last, first, date, SUM(hours) as sum FROM hours JOIN students ON hours.ID = students.ID WHERE students.team = '$team' AND hours.date > NOW() - INTERVAL 42 DAY AND hours.date > '2017-08-19' GROUP BY hours.ID ORDER BY sum DESC";
