...
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/guardians.php">Guardians</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/rosters2.php">Rosters</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/rosters.php">Rosters with cell</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/rosters_email.php">Emails</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/parents.php">Parents</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/paperwork.php">Update Paperwork</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/safetytests.php">Update Safety Tests</a><br>
<a href="https://just164.justhost.com/~nemosha1/timeclock/admin/clocked_in.php">Clocked In Now</a><br>
</p>
<?php
...
foreach ($teams as $team){
	...
	while($row = mysqli_fetch_assoc($result)){
		echo "<tr>";
		echo "<form method='post' style='margin: 0; padding: 0;' action='https://just164.justhost.com/~nemosha1/timeclock/admin/update_team.php'>";
		...
		echo "<td><a href='https://just164.justhost.com/~nemosha1/timeclock/admin/student_hours.php?idfield={$row['ID']}'>Hours</a></td>";
		echo "<td>";
