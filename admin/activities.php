...
require_once '../db.php';
//db query
$sql = "SELECT ID, first, last, email, team, cell, gradclass, role, activities FROM students ORDER BY CASE team WHEN '967' THEN 1 WHEN '4150' THEN 2 WHEN '4324' THEN 3 WHEN '10107' THEN 4 WHEN 'Mentors' THEN 5 END, last, first";
