...
foreach ($teams as $team){
	$sql = "SELECT team, last, first, SUM(hours), date as sum FROM hours JOIN students ON hours.ID = students.ID WHERE students.team = '$team' AND hours.date > NOW() - INTERVAL 30 DAY AND hours.date > '2017-08-19' GROUP BY hours.ID ORDER BY sum DESC";
